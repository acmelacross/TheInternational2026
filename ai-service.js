...
function createAiService({ root, dataDir }) {
  ...
  async function retryProvider(context, providerId){
  ...
  return{getStatus,getCachedAnalysis,analyzeOnce,retryProvider,configuredCount};
}
